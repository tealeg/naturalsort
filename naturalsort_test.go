...
func (suite *NaturalSortTestSuite) TestSortAlpha() {
	item0 := item{parts: partList{runePart{runeVal: 'e'}, runePart{runeVal: 'd'}, runePart{runeVal: 'f'}}}
	item1 := item{parts: partList{runePart{runeVal: 'a'}, runePart{runeVal: 'b'}, runePart{runeVal: 'z'}}}
	item2 := item{parts: partList{runePart{runeVal: 'a'}, runePart{runeVal: 'e'}, runePart{runeVal: 'g'}}}
...
func (suite *NaturalSortTestSuite) TestSortMixed() {
	item0 := item{parts: partList{intPart{intVal: 700}}}
	item1 := item{parts: partList{runePart{runeVal: 'a'}}}
	item2 := item{parts: partList{intPart{intVal: 80}}}
	item3 := item{parts: partList{runePart{runeVal: 'b'}}}
...
func (suite *NaturalSortTestSuite) TestSortSubItems() {
	item0 := item{parts: partList{runePart{runeVal: 'a'}, intPart{intVal: 1}}}
	item1 := item{parts: partList{runePart{runeVal: 'a'}}}
	item2 := item{parts: partList{runePart{runeVal: 'a'}, intPart{intVal: 1}, runePart{runeVal: 'a'}}}
	items := []item{item0, item1, item2}
	sort.Sort(ByNaturalOrder(items))
	suite.Equal(item1, items[0])
	suite.Equal(item0, items[1])
...
func (suite *NaturalSortTestSuite) TestSortCompounds() {
	item0 := item{parts: partList{runePart{runeVal: 'a'}, intPart{intVal: 1}}}
	item1 := item{parts: partList{runePart{runeVal: 'a'}, intPart{intVal: 0}, runePart{runeVal: 'a'}}}
	item2 := item{parts: partList{intPart{intVal: 2}, runePart{runeVal: 'a'}}}
	item3 := item{parts: partList{runePart{runeVal: 'b'}, intPart{intVal: 9}}}
	item4 := item{parts: partList{intPart{intVal: 10}, runePart{runeVal: 'a'}}}
	item5 := item{parts: partList{runePart{runeVal: 'b'}, intPart{intVal: 80}}}
	item6 := item{parts: partList{runePart{runeVal: 'a'}, intPart{intVal: 0}, runePart{runeVal: 'a'}, runePart{runeVal: 'b'}}}
